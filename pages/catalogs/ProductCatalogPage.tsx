...
const ProductModal: React.FC<{
  ...
  const unitOptions = productUnits.map(u => ({ value: u.name, label: u.name }));
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <CustomSelect 
                  ...
                  value={formData.pricingModel || PricingModel.Fixed}
                  onChange={(val) => setFormData(prev => ({ ...prev, pricingModel: val as PricingModel }))}
                />
              </div>
              <div>
    ...
    <>
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Quản lý Danh mục Sản phẩm</h1>
