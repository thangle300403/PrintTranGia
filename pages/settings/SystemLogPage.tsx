...
const AccessLogContent: React.FC = () => {
...
const SystemLogPage: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Nhật ký hệ thống</h1>
            ...
            <div className="min-h-[600px]">
                {activeTab === 'access' ? <AccessLogContent /> : <ActivityLogContent />}
            </div>
        </div>
    );
};
