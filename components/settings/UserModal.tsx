...
import { User, Gender, MaritalStatus, EmploymentStatus, PERMISSION_NAMES, Permission } from '../../types';
import { UserCircleIcon, CheckCircleIcon, PlusIcon, CloseIcon, UploadIcon, UserGroupIcon, CreditCardIcon, DocumentTextIcon, CheckIcon } from '../icons/Icons';
...
export const UserModal: React.FC<UserModalProps> = ({ user, onClose, onSave }) => {
  const { roles, commissionPolicies } = useData();
