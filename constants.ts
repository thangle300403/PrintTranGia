...
export const MOCK_NAVIGATION_MENU: MenuItem[] = [
    ...
    { id: 'menu_6_1', parentId: 'menu_6', label: 'Báo giá', path: '/quotes', order: 0, permission: 'create_quotes' },
    { id: 'menu_6_2', parentId: 'menu_6', label: 'Hợp đồng', path: '/contracts', order: 1, permission: 'manage_contracts' },
    { id: 'menu_6_3', parentId: 'menu_6', label: 'Đơn hàng', path: '/orders', order: 2, permission: 'manage_orders' },
    { id: 'menu_6_5', parentId: 'menu_6', label: 'Khách hàng', path: '/customers', order: 3, permission: 'manage_customers' },
...
export const MOCK_ROLES: Role[] = [
    { 
        ...
        isSystem: true,
        permissions: [
            'manage_users', 'create_quotes', 'approve_quotes', 'manage_orders', 'manage_invoices', 'manage_customers', 'use_pos', 'manage_company_info', 'manage_numbering_rules', 'manage_cash_fund', 'view_reports', 'manage_contracts', 'view_accounting', 'manage_subscription', 'manage_production_orders', 'manage_menu', 'manage_custom_modules',
            ...
            'view_raw_materials', 'create_raw_materials', 'edit_raw_materials', 'delete_raw_materials', 'manage_print_templates',
    ...
    },
    {
        ...
        permissions: ['view_reports', 'approve_quotes', 'view_accounting', 'view_logs', 'view_commissions']
    },
    {
        id: 'role_sales_manager',
        name: 'Trưởng phòng Kinh doanh',
        description: 'Quản lý đội ngũ kinh doanh, duyệt báo giá, xem báo cáo doanh thu.',
        permissions: ['create_quotes', 'approve_quotes', 'manage_orders', 'manage_customers', 'view_reports', 'view_products', 'view_materials', 'view_processes', 'view_print_methods', 'view_units', 'manage_contracts', 'manage_promotions', 'view_commissions']
    },
    {
        id: 'role_sales_staff',
        name: 'Nhân viên Kinh doanh',
        description: 'Tạo báo giá, đơn hàng, quản lý khách hàng của mình.',
        permissions: ['create_quotes', 'manage_orders', 'manage_customers', 'view_products', 'view_materials', 'view_processes', 'view_print_methods', 'view_units', 'use_pos', 'view_commissions']
    },
    {
        id: 'role_chief_accountant',
        name: 'Kế toán trưởng',
        description: 'Quản lý toàn bộ hoạt động kế toán, quỹ, công nợ.',
        permissions: ['manage_invoices', 'manage_cash_fund', 'view_reports', 'view_accounting', 'manage_contracts', 'manage_purchasing']
    },
    {
        id: 'role_accountant',
        name: 'Kế toán viên',
        description: 'Ghi nhận thu chi, xuất hóa đơn.',
        permissions: ['manage_invoices', 'manage_cash_fund']
    },
    {
        id: 'role_warehouse',
        name: 'Thủ kho',
        description: 'Quản lý xuất nhập tồn kho.',
        permissions: ['view_products', 'edit_products', 'view_raw_materials', 'manage_production_orders', 'manage_inventory_conversion', 'manage_purchasing']
    },
    {
        id: 'role_production',
...
<div id="lsx-popup-overlay">
    <div class="lsx-popup">
        ...
        <div class="lsx-popup__footer">
            <button class="btn btn-popup-in" onclick="window.print()">In Lệnh Sản Xuất</button>
        </div>
    </div>
</div>
