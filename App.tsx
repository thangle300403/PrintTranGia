...
const PointOfSalePage = lazy(() =>
  import("./pages/pos/PointOfSalePage").then((module) => ({
    default: module.default,
  })),
);
const ProductionOrderListPage = lazy(
  () => import("./pages/production/ProductionOrderListPage"),
);
...
const ContractCreatePage = lazy(
  () => import("./pages/contracts/ContractCreatePage"),
);
...
const OrderListPage = lazy(() =>
  import("./pages/orders/OrderListPage").then((module) => ({
    default: module.default,
  })),
);
...
const CustomerPortalPage = lazy(
  () => import("./pages/portal/CustomerPortalPage"),
);
...
const SupplierListPage = lazy(() =>
  import("./pages/purchasing/SupplierListPage").then((module) => ({
    default: module.default,
  })),
);
const DebtCollectionPage = lazy(
  () => import("./pages/accounting/DebtCollectionPage"),
);

// Update Lazy loading for consistency
const CashFlowPage = lazy(() =>
  import("./pages/accounting/CashFlowPage").then((module) => ({
    default: module.default,
  })),
);
// Update Lazy loading for consistency
const BankFlowPage = lazy(() =>
  import("./pages/accounting/BankFlowPage").then((module) => ({
    default: module.default,
  })),
);
...
const BankReconciliationPage = lazy(
  () => import("./pages/accounting/BankReconciliationPage"),
);
...
const NumberingRulesPage = lazy(
  () => import("./pages/settings/NumberingRulesPage"),
);
...
const CustomizationPage = lazy(() =>
  import("./pages/settings/CustomizationPage").then((module) => ({
    default: module.default,
  })),
);
const PrintTemplatePage = lazy(
  () => import("./pages/settings/PrintTemplatePage"),
);
...
const ProductCatalogPage = lazy(
  () => import("./pages/catalogs/ProductCatalogPage"),
);
const MaterialCatalogPage = lazy(
  () => import("./pages/catalogs/MaterialCatalogPage"),
);
const RawMaterialCatalogPage = lazy(
  () => import("./pages/catalogs/RawMaterialCatalogPage"),
);
const ProcessCatalogPage = lazy(
  () => import("./pages/catalogs/ProcessCatalogPage"),
);
const PrintMethodCatalogPage = lazy(
  () => import("./pages/catalogs/PrintMethodCatalogPage"),
);
const UnitCatalogPage = lazy(() => import("./pages/catalogs/UnitCatalogPage"));
const PaperConvertingPage = lazy(
  () => import("./pages/warehouse/PaperConvertingPage"),
);
...
const CustomObjectListPage = lazy(
  () => import("./pages/custom/CustomObjectListPage"),
);
const CustomObjectCreatePage = lazy(
  () => import("./pages/custom/CustomObjectCreatePage"),
);
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route
                path="/accounting/debt-collection"
                element={<DebtCollectionPage />}
              />
              ...
              <Route
                path="/cash-fund/cash-ledger"
                element={<CashLedgerPage />}
              />
              <Route path="/cash-fund/bank-flow" element={<BankFlowPage />} />
              <Route
                path="/cash-fund/bank-reconciliation"
                element={<BankReconciliationPage />}
              />
              <Route
                path="/cash-fund/bank-ledger"
              ...
              <Route
                ...
                element={<MaterialCatalogPage />}
              />
              <Route
                path="/catalogs/raw-materials"
                element={<RawMaterialCatalogPage />}
              />
              <Route
                path="/catalogs/processes"
                element={<ProcessCatalogPage />}
              />
              <Route
                path="/catalogs/print-methods"
                element={<PrintMethodCatalogPage />}
              />
              <Route path="/catalogs/units" element={<UnitCatalogPage />} />
              <Route
                path="/catalogs/paper-conversion"
                element={<PaperConvertingPage />}
              />
              <Route path="/catalogs/bom" element={<BOMPage />} />
              <Route
                path="/catalogs/other-costs"
                element={<OtherCostsPage />}
              />
              ...
              <Route
                ...
                element={<CustomObjectCreatePage />}
              />
              <Route
                path="/custom/:slug/:id/edit"
                element={<CustomObjectCreatePage />}
              />
